            ...
            <div class="content">
               <div class="container">
                  ...
                  <div class="row">
                     <div class="col-sm-12">
                        <div class="card-box">
                           <h4 class="m-t-0 header-title"><b>Add a new Contact </b></h4>
                           <hr />
                           <div class="row">
                              <form class="row" name="addsuadmin" method="post">
                                 ...
                                 <div class="form-group col-md-6">
                                    <label for="password">Descripture</label>
                                    <!-- <input type="password" class="form-control" id="pwd" name="pwd" placeholder="Enter password" required> -->
                                    <textarea name="" id="" class="form-control"  rows="6" style="border-radius: 5px;" ></textarea>
                                 </div>
